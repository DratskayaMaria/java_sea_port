...
public class Ship implements Comparable<Ship>{
    ...
    private int generatePortBerthTime(){
        if (nameOfCargoType.equals(LOOSE)){
            return (int)Math.ceil(weightOfCargoType / Crane.LOOSE_CRANE_PRODUCTIVITY);
        }else if (nameOfCargoType.equals(LIQUID)){
            return (int)Math.ceil(weightOfCargoType / Crane.LIQUID_CRANE_PRODUCTIVITY);
        }else{
            return (int)Math.ceil(weightOfCargoType / Crane.CONTAINER_CRANE_PRODUCTIVITY);
        }
    }
