...
public class Statistics {
    ...
    public Statistics() {
        this.sumOfLengthsOfUnloadingQueue = 0;
        this.numberOfLengthsOfUnloadingQueue = 0;
        this.numberOfUnloadedShips = 0;
        this.averageLengthQueueForUnloading = 0;
        this.averageWaitingTimeInTheQueue = 0;
        this.maxUnloadingDelay = 0;
        this.averageUnloadingDelay = 0;
        this.amountOfFineLoose = 0;
        this.amountOfFineLiqiud = 0;
        this.amountOfFineContainer = 0;
        this.requiredNumberOfLooseCranes = 0;
        this.requiredNumberOfLiquidCranes = 0;
        this.requiredNumberOfContainerCranes = 0;
        this.unloadedShips = new LinkedBlockingQueue<>();
    }
